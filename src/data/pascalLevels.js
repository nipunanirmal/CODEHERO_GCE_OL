export const pascalLevels = [
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'p1', text: 'program Hello(input, output);' },
            { id: 'p2', text: 'begin' },
            { id: 'p3', text: '  writeln(\'Hello\');' },
            { id: 'p4', text: '  readln;' },
            { id: 'p5', text: 'end.' }
        ],
        correctOrder: ['program Hello(input, output);', 'begin', '  writeln(\'Hello\');', '  readln;', 'end.'],
        output: 'Hello',
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'v1', text: 'program VarDemo(input, output);' },
            { id: 'v2', text: 'var age: integer;' },
            { id: 'v4', text: 'begin' },
            { id: 'v5', text: '  age := 16;' },
            { id: 'v6', text: 'end.' }
        ],
        correctOrder: ['program VarDemo(input, output);', 'var age: integer;', 'begin', '  age := 16;', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'io_p', text: 'program HelloUser(input, output);' },
        ...
        correctOrder: ['program HelloUser(input, output);', 'var name: string;', 'begin', '  write(\'Enter Name: \');', '  readln(name);', '  writeln(\'Hello \', name);', 'end.'],
    ...
    // --- PHASE 2: CALCULATIONS & VARIABLES (6-10) ---
    {
        ...
        availableBlocks: [
            { id: 'c_p', text: 'program AddNums(input, output);' },
        ...
        correctOrder: ['program AddNums(input, output);', 'var a, b, sum: integer;', 'begin', '  a := 10; b := 20;', '  sum := a + b;', '  writeln(sum);', 'end.'],
        output: '30',
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'a_p', text: 'program CalcAvg(input, output);' },
            { id: 'a1', text: 'var total: integer; avg: real;' },
            { id: 'a2', text: 'begin' },
            { id: 'a3', text: '  total := 250;' },
            { id: 'a4', text: '  avg := total / 3;' },
            { id: 'a5', text: '  writeln(avg);' },
            { id: 'a6', text: 'end.' }
        ],
        correctOrder: ['program CalcAvg(input, output);', 'var total: integer; avg: real;', 'begin', '  total := 250;', '  avg := total / 3;', '  writeln(avg);', 'end.'],
        output: '83.33',
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'ar_p', text: 'program CircleArea(input, output);' },
        ...
        correctOrder: ['program CircleArea(input, output);', 'const pi = 3.14;', 'var r, area: real;', 'begin', '  r := 7;', '  area := pi * r * r;', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'sw_p', text: 'program SwapVars(input, output);' },
        ...
        correctOrder: ['program SwapVars(input, output);', 'var x, y, temp: integer;', 'begin', '  x:=5; y:=10;', '  temp := x;', '  x := y;', '  y := temp;', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'p_p', text: 'program CalcTotal(input, output);' },
        ...
        correctOrder: ['program CalcTotal(input, output);', 'var price, total: real;', '    qty: integer;', 'begin', '  price := 120.50; qty := 5;', '  total := price * qty;', 'end.']
    },
    ...
    // --- PHASE 3: SELECTION (IF/ELSE) (11-20) ---
    {
        ...
        availableBlocks: [
            { id: 'if_p', text: 'program CheckPos(input, output);' },
            { id: 'if_v', text: 'var num: integer;' },
            { id: 'if_bg', text: 'begin' },
            { id: 'if_init', text: '  num := 10;' },
            { id: 'if1', text: '  if num > 0 then' },
            { id: 'if2', text: '    writeln(\'Positive\');' },
            { id: 'if_ed', text: 'end.' }
        ],
        correctOrder: ['program CheckPos(input, output);', 'var num: integer;', 'begin', '  num := 10;', '  if num > 0 then', '    writeln(\'Positive\');', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'ie_p', text: 'program PassFail(input, output);' },
            { id: 'ie_v', text: 'var marks: integer;' },
            { id: 'ie_bg', text: 'begin' },
            { id: 'ie_init', text: '  marks := 55;' },
        ...
        correctOrder: ['program PassFail(input, output);', 'var marks: integer;', 'begin', '  marks := 55;', '  if marks >= 50 then', '    writeln(\'Pass\')', '  else', '    writeln(\'Fail\');', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'oe_p', text: 'program OddEven(input, output);' },
            { id: 'oe_v', text: 'var num: integer;' },
            { id: 'oe_bg', text: 'begin' },
            { id: 'oe_init', text: '  num := 4;' },
        ...
        correctOrder: ['program OddEven(input, output);', 'var num: integer;', 'begin', '  num := 4;', '  if num mod 2 = 0 then', '    writeln(\'Even\')', '  else', '    writeln(\'Odd\');', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'mx_p', text: 'program FindMax(input, output);' },
            { id: 'mx_v', text: 'var a, b: integer;' },
            { id: 'mx_bg', text: 'begin' },
            { id: 'mx_init', text: '  a := 10; b := 20;' },
        ...
        correctOrder: ['program FindMax(input, output);', 'var a, b: integer;', 'begin', '  a := 10; b := 20;', '  if a > b then', '    writeln(a)', '  else', '    writeln(b);', 'end.']
    },
    {
        id: 'pas-15',
        ...
        availableBlocks: [
            { id: 'ad_p', text: 'program Eligibility(input, output);' },
            { id: 'ad_v', text: 'var age, marks: integer;' },
            { id: 'ad_bg', text: 'begin' },
            { id: 'ad_init', text: '  age := 19; marks := 75;' },
            { id: 'ad1', text: '  if (age > 18) and (marks > 50) then' },
            { id: 'ad2', text: '    writeln(\'Eligible\');' },
            { id: 'ad_ed', text: 'end.' }
        ],
        correctOrder: ['program Eligibility(input, output);', 'var age, marks: integer;', 'begin', '  age := 19; marks := 75;', '  if (age > 18) and (marks > 50) then', '    writeln(\'Eligible\');', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'ni_p', text: 'program NestedIf(input, output);' },
        ...
        correctOrder: ['program NestedIf(input, output);', 'var num: integer;', 'begin', '  num := 100;', '  if num > 0 then', '    if num = 100 then', '      writeln(\'Perfect\');', 'end.']
    },
    {
        id: 'pas-17',
        title: 'Leap Year',
        ...
        availableBlocks: [
            { id: 'ly_p', text: 'program LeapYear(input, output);' },
        ...
        correctOrder: ['program LeapYear(input, output);', 'var year: integer;', 'begin', '  year := 2024;', '  if year mod 4 = 0 then', '    writeln(\'Leap Year\');', 'end.']
    },
    {
        id: 'pas-18',
        ...
        availableBlocks: [
            { id: 'el_p', text: 'program Grades(input, output);' },
            { id: 'el_v', text: 'var marks: integer;' },
            { id: 'el_bg', text: 'begin' },
            { id: 'el_init', text: '  marks := 80;' },
            { id: 'el1', text: '  if marks > 75 then writeln(\'A\')' },
            { id: 'el2', text: '  else if marks > 50 then writeln(\'B\')' },
            { id: 'el3', text: '  else writeln(\'C\');' },
            { id: 'el_ed', text: 'end.' }
        ],
        correctOrder: ['program Grades(input, output);', 'var marks: integer;', 'begin', '  marks := 80;', '  if marks > 75 then writeln(\'A\')', '  else if marks > 50 then writeln(\'B\')', '  else writeln(\'C\');', 'end.']
    },
    {
        id: 'pas-19',
        title: 'Login Check',
        ...
        availableBlocks: [
            { id: 'lc_p', text: 'program Login(input, output);' },
            { id: 'lc_v', text: 'var pass: string;' },
            { id: 'lc_bg', text: 'begin' },
            { id: 'lc_init', text: '  pass := \'123\';' },
        ...
        correctOrder: ['program Login(input, output);', 'var pass: string;', 'begin', '  pass := \'123\';', '  if pass = \'123\' then', '    writeln(\'Access Granted\')', '  else', '    writeln(\'Access Denied\');', 'end.']
    },
    {
        id: 'pas-20',
        ...
        availableBlocks: [
            { id: 'cs_p', text: 'program Weekday(input, output);' },
            { id: 'cs_v', text: 'var day: integer;' },
            { id: 'cs_bg', text: 'begin' },
            { id: 'cs_init', text: '  day := 2;' },
        ...
        correctOrder: ['program Weekday(input, output);', 'var day: integer;', 'begin', '  day := 2;', '  case day of', '    1: writeln(\'Monday\');', '    2: writeln(\'Tuesday\');', '  end;', 'end.'],
    ...
    // --- PHASE 4: ITERATION (LOOPS) (21-30) ---
    {
        ...
        availableBlocks: [
            { id: 'fl1', text: 'program Loop(input, output);' },
        ...
        correctOrder: ['program Loop(input, output);', 'var i: integer;', 'begin', '  for i := 1 to 5 do', '  begin', '    writeln(i);', '  end;', 'end.'],
        output: '1\n2\n3\n4\n5',
        explanation: 'තනි පේළියක් ඇති විට begin/end අනිවාර්ය නැත, නමුත් මෙහි පුහුණුවීම සදහා එය යොදා ඇත.'
    },
    {
        id: 'pas-22',
        ...
        availableBlocks: [
            { id: 'fr1', text: 'program Rev(input, output);' },
        ...
        correctOrder: ['program Rev(input, output);', 'var i: integer;', 'begin', '  for i := 5 downto 1 do', '  begin', '    writeln(i);', '  end;', 'end.'],
    },
    {
        id: 'pas-23',
        title: 'WHILE Loop',
        ...
        availableBlocks: [
            { id: 'wl1', text: 'program WhileLoop(input, output);' },
        ...
        correctOrder: ['program WhileLoop(input, output);', 'var x: integer;', 'begin', '  x := 0;', '  while x < 5 do', '  begin', '    writeln(x);', '    x := x + 1;', '  end;', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'rp_p', text: 'program RepeatLoop(input, output);' },
        ...
        correctOrder: ['program RepeatLoop(input, output);', 'var x: integer;', 'begin', '  x := 0;', '  repeat', '    x := x + 1;', '    writeln(x);', '  until x = 10;', 'end.'],
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'sm_p', text: 'program Summation(input, output);' },
        ...
        correctOrder: ['program Summation(input, output);', 'var i, sum: integer;', 'begin', '  sum := 0;', '  for i := 1 to 10 do', '  begin', '    sum := sum + i;', '  end;', '  writeln(sum);', 'end.']
    },
    {
        id: 'pas-26',
        ...
        availableBlocks: [
            { id: 'mt1', text: 'program Table(input, output);' },
        ...
        correctOrder: ['program Table(input, output);', 'var i: integer;', 'begin', '  for i := 1 to 12 do', '  begin', '    writeln(2, \' * \', i, \' = \', 2*i);', '  end;', 'end.']
    },
    {
        id: 'pas-27',
        ...
        availableBlocks: [
            { id: 'sq_p', text: 'program Squares(input, output);' },
        ...
        correctOrder: ['program Squares(input, output);', 'var i: integer;', 'begin', '  for i := 1 to 5 do', '  begin', '    writeln(i * i);', '  end;', 'end.']
    },
    {
        id: 'pas-28',
        title: 'Input Loop',
        ...
        availableBlocks: [
            { id: 'il_p', text: 'program InputLoop(input, output);' },
        ...
        correctOrder: ['program InputLoop(input, output);', 'var num: integer;', 'begin', '  repeat', '    readln(num);', '  until num = 0;', 'end.']
    },
    {
        id: 'pas-29',
        ...
        availableBlocks: [
            { id: 'pt_p', text: 'program Patterns(input, output);' },
        ...
        correctOrder: ['program Patterns(input, output);', 'var i: integer;', 'begin', '  for i := 1 to 5 do', '  begin', '    write(\'*\');', '  end;', 'end.'],
        output: '*****',
    ...
    },
    {
        ...
        availableBlocks: [
            { id: 'en_p', text: 'program EvenNums(input, output);' },
        ...
        correctOrder: ['program EvenNums(input, output);', 'var i: integer;', 'begin', '  for i := 1 to 10 do', '  begin', '    if i mod 2 = 0 then', '    begin', '      writeln(i);', '    end;', '  end;', 'end.']
    }
];
