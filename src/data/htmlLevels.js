export const htmlLevels = [
  {
    id: 'html-1',
    title: 'HTML පදනම',
    description: 'HTML ව්යුහය සහ මූලික ටැග්',
    sinhalaTitle: 'HTML පදනම',
    sinhalaDesc: 'HTML ව්යුහය සහ මූලික ටැග්',
    type: 'coding',
    starterCode: '<!DOCTYPE html>\n<html>\n<head>\n    <title>මගේ පිටුව</title>\n</head>\n<body>\n    <!-- ඔබගේ කේතය මෙතැන ලියන්න -->\n</body>\n</html>',
    solution: '<!DOCTYPE html>\n<html>\n<head>\n    <title>මගේ පිටුව</title>\n</head>\n<body>\n    <h1>සුභ දවසක්!</h1>\n    <p>මෙය මගේ පළමු HTML පිටුවයි.</p>\n</body>\n</html>',
    instructions: {
      sinhala: 'h1 ටැගයක් භාවිතා කර "සුභ දවසක්!" යනුවෙන් මාතෘකාවක් සහ p ටැගයක් භාවිතා කර වාක්ය ඛණ්ඩයක් එකතු කරන්න。',
      english: 'Add an h1 tag with "Hello World!" and a p tag with a sentence.'
    },
    hints: [
      'h1 ටැගය මහත්ම මාතෘකා සඳහා යොදා ගනී',
      'p ටැගය වාක්ය ඛණ්ඩ සඳහා යොදා ගනී'
    ],
    xp: 10
  },
  {
  ...
  },
  {
    ...
    instructions: {
      sinhala: 'form ටැගයක් භාවිතා කර සම්බන්ධතා ආකෘතියක් සාදන්න. නම, ඊමේල්, සහ පණිවිඩ ක්ෂේත්ර ඇතුළත් කරන්න。',
      english: 'Create a contact form using form tag with name, email, and message fields.'
    },
    hints: [
      'form ටැගය ආදාන ආකෘති සඳහා',
      'label ටැගය ක්ෂේත්ර ලේබල් කිරීමට',
  ...
  },
  {
    ...
    hints: [
      ...
      'nav යාවත්කාලීන සබැඳි සඳහා',
      'main ප්රධාන අන්තර්ගතය සඳහා',
  ...
  {
    id: 'html-9',
    title: 'මාධ්ය අන්තර්ගතය',
    description: 'වීඩියෝ සහ ශ්රව්ය එකතු කිරීම',
    sinhalaTitle: 'මාධ්ය අන්තර්ගතය',
    sinhalaDesc: 'වීඩියෝ සහ ශ්රව්ය එකතු කිරීම',
    type: 'coding',
    starterCode: '<!DOCTYPE html>\n<html>\n<head>\n    <title>මාධ්ය අන්තර්ගතය</title>\n</head>\n<body>\n    <!-- වීඩියෝ සහ ශ්රව්ය එකතු කරන්න -->\n</body>\n</html>',
    solution: '<!DOCTYPE html>\n<html>\n<head>\n    <title>මාධ්ය අන්තර්ගතය</title>\n</head>\n<body>\n    <h2>වීඩියෝ</h2>\n    <video width="400" controls>\n        <source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4">\n        ඔබගේ බ්රව්සරය video ටැගය සහාය නොදක්වයි.\n    </video>\n    \n    <h2>ශ්රව්ය</h2>\n    <audio controls>\n        <source src="https://www.w3schools.com/html/horse.mp3" type="audio/mpeg">\n        ඔබගේ බ්රව්සරය audio ටැගය සහාය නොදක්වයි.\n    </audio>\n</body>\n</html>',
    instructions: {
      sinhala: 'video ටැගයක් සහ audio ටැගයක් භාවිතා කර මාධ්ය අන්තර්ගතය එකතු කරන්න。',
      english: 'Add media content using video and audio tags.'
    },
    hints: [
      'video ටැගය වීඩියෝ සඳහා',
      'audio ටැගය ශ්රව්ය සඳහා',
  ...
  {
    id: 'html-10',
    title: 'ව්යාපෘතිය - පුද්ගලික පැතිකඩ',
    description: 'සම්පූර්ණ පුද්ගලික පැතිකඩක් සාදයි',
    sinhalaTitle: 'ව්යාපෘතිය - පුද්ගලික පැතිකඩ',
    ...
    instructions: {
      sinhala: 'සම්පූර්ණ පුද්ගලික පැතිකඩක් සාදන්න. header, nav, main, footer භාවිතා කර මම කවුද, කුසලතා, ව්යාපෘති, සහ සම්බන්ධතා කොටස් ඇතුළත් කරන්න。',
    ...
    hints: [
      'semantic HTML ව්යුහය භාවිතා කරන්න',
